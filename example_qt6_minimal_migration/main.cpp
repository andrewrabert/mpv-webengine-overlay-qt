...
public:
    ...
    void render()
    {
        ...
        // Qt6: Removed resetOpenGLState() - doesn't exist (use beginExternalCommands/endExternalCommands in RHI)
...
private slots:
    ...
    void onSynchronize()
    {
        if (!m_renderer && m_mpv) {
            ...
            // Hook into rendering pipeline (same as Qt5)
            ...
            // Qt6: Removed setPersistentOpenGLContext/setPersistentSceneGraph (automatic in Qt6)
            // Qt6: Removed setClearBeforeRendering (doesn't exist - clearing always happens)
        }
...
{
    // Must initialize QtWebEngineQuick before QGuiApplication
