...
| `example_qt6_hdr_wayland`    | Qt6.7 | HDR10 via Wayland subsurface; `vo=gpu-next` and vulkan via non-upstream [libmpv](https://github.com/andrewrabert/mpv/tree/libmpv-vulkan-gpu-next) |
